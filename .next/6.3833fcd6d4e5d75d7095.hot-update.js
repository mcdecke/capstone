...
function (_Component) {
  ...
  _createClass(App, [{
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                console.log('hi');
                _context.next = 3;
                return __WEBPACK_IMPORTED_MODULE_2__src_ethereum_factory_js__["a" /* default */].methods.getDeployedPasswordBlocks().call();

              case 3:
                passwordBlocks = _context.sent;
                console.log(passwordBlocks[0]);
                this.setState({
                  passwordList: passwordBlocks[0]
                });
    ...
    value: function render() {
      ...
      }, "HULLO URF", __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement("br", {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 105
        }
      }), this.passwordBlocks[0]);
    }
  }]);
...
//# sourceMappingURL=6.3833fcd6d4e5d75d7095.hot-update.js.map